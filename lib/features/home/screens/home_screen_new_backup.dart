...
class _HomeScreenNewState extends ConsumerState<HomeScreenNew>
  ...
  bool _isStudyTimeExpanded = false;
  ...
  final List<Map<String, dynamic>> _todos = [
    {'title': '수학 문제집 30페이지', 'completed': true, 'subject': '수학'},
    {'title': '영어 단어 암기', 'completed': false, 'subject': '영어'},
    {'title': '국어 비문학 3지문', 'completed': false, 'subject': '국어'},
    {'title': '물리 실험 보고서', 'completed': false, 'subject': '과학'},
    {'title': '한국사 연표 정리', 'completed': false, 'subject': '한국사'},
  ];
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  ListTile(
                    leading: const Icon(Icons.note_add, color: Color(0xFF638ECB)),
                    title: const Text('노트'),
                    onTap: () {
                      Navigator.pop(context);
                  ...
                  ListTile(
                    leading: const Icon(Icons.history, color: Color(0xFF638ECB)),
                    title: const Text('기록'),
                    onTap: () {
                      Navigator.pop(context);
