...
import '../features/study/screens/exam_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      // Gamification Routes (can be accessed from various places)
      GoRoute(
        path: '/quest',
        name: 'quest',
      ...
      // Tools Routes (can be accessed from various places)
      GoRoute(
        path: '/note',
        name: 'note',
    ...
    redirect: (context, state) {
      ...
      if (isAuth && 
          (authState.user?.learningType?.isEmpty ?? true) && 
          !isOnboardingRoute) {
        return '/learning-type-test';
      }
      
      // If authenticated and trying to access auth routes
      if (isAuth && isAuthRoute && location != '/') {
        return '/home';
      }
